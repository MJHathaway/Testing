describe("To log into my Twitter account",function(){
	...
	it("validate that i logged into Twitter",function(){
     ...
     element(by.css('.AdaptiveFiltersBar-target.u-textUserColor')).click();
     ...
     element(by.css('.account-group.js-account-group.js-action-profile.js-user-profile-link.js-nav > .avatar.js-action-profile-avatar')).click();
     ...
     elm.sendKeys("@HatechLLC Hi My name is Michael Hathaway you can follow me at @Michael79041164");
