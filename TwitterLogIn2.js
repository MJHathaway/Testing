describe("To log into my Twitter account",function(){
	...
	it("validate that i logged into Twitter",function(){
     ...
     element(by.css('.following > .user-actions-follow-button.js-follow-btn.follow-button')).click();
     ...
     var elm = element(by.css('#tweet-box-home-timeline'));
          ...
          elm.sendKeys("@HatechLLC Hi My name is Michael Hathaway you can unfollow me at @Michael79041164");
